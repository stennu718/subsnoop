...
function SettingRow({
  ...
  return (
    <div className="flex items-center justify-between py-5 px-6 border-b border-[var(--border)] last:border-0">
      <div>
  ...
  return (
    <div className="flex flex-col min-h-full">
      ...
      <main className="flex-1 max-w-[720px] w-full mx-auto px-8 py-10">
        ...
        <p className="text-base text-[var(--text-secondary)] mt-1.5 mb-10">
        ...
        <Section title="Connected Accounts">
          {connectedBanks.map((bank) => (
            <div
              key={bank.name}
              className="flex items-center gap-3.5 py-5 px-6 border-b border-[var(--border)] last:border-0"
            >
              <div
          ...
          {/* Add new */}
          <div className="flex items-center gap-3.5 py-5 px-6">
        ...
        <Section title="Detection Preferences">
          <SettingRow
            ...
            control={
              <select className="px-3 py-2 border border-[var(--border)] rounded-lg text-sm font-medium bg-white cursor-pointer min-w-[160px]">
        ...
        <Section title="Data Management">
          <SettingRow
            ...
            control={<Button variant="outline" size="sm">Export CSV</Button>}
          />
          <SettingRow
            name="Purge Transaction Cache"
            desc="Remove cached bank data (keeps subscriptions)"
            control={<Button variant="outline" size="sm">Purge Cache</Button>}
          />
          <SettingRow
            name="Delete All Data"
            desc="Permanently delete all tracked subscriptions"
            control={<Button variant="outline-danger" size="sm">Delete All</Button>}
          />
        </Section>
